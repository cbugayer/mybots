...
BLtargetAngles = np.linspace(0, 2*np.pi, 1000)
BLtargetAngles = BLamplitude*np.sin(BLfrequency*BLtargetAngles+BLphaseOffset)
FLtargetAngles = np.linspace(0, 2*np.pi, 1000)
FLtargetAngles = FLamplitude*np.sin(FLfrequency*FLtargetAngles+FLphaseOffset)
