...
class SOLUTION:
    ...
    def __init__(self, AvailableID):
        ...
        self.weights = numpy.random.rand(len(self.rand_links), self.num_linksX,self.num_links)
    ...
    def Mutate(self):
        ...
        self.weights[numpy.random.randint(0, len(self.rand_links))][randRow][randColumn] = random.random() * 2 - 1
        #print(self.weights)
